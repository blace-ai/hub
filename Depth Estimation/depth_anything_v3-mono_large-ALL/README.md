<h2 style="text-align:center;">Depth Anything 3 (mono_large)</h2>

C++ (Windows, Linux, MacOS / CUDA and Metal accelerated) port of [https://github.com/ByteDance-Seed/Depth-Anything-3.git](https://github.com/ByteDance-Seed/Depth-Anything-3.git).

### Example Input & Outputs
| Inputs | Outputs |
|--------|----------|
| <img src="butterfly.jpg" alt="Depth Input" width="512"/> Depth Input | <img src="depth_anything_v3-mono_large-ALL_depth_result.png" alt="Depth Result" width="512"/> Depth Result |
...
#include "depth_anything_v3_v6_mono_large_v1_ALL_export_version_v26.h"
...
int main() {
  ...
  auto infer_op = depth_anything_v3_v6_mono_large_v1_ALL_export_version_v26_run(
...
```
Tested on version [v1.2.0](https://github.com/blace-ai/blace-ai/releases/tag/v1.2.0) of blace.ai sdk. Might also work on newer or older releases (check if release notes of blace.ai state breaking changes).

### Quickstart
1. Download [blace.ai SDK](https://github.com/blace-ai/blace-ai/releases/tag/v1.2.0) and unzip. In the bootstrap script `build_run_demos.ps1` (Windows) or `build_run_demos.sh` (Linux/MacOS) set the `BLACE_AI_CMAKE_DIR` environment variable to the `cmake` folder inside the unzipped SDK, e.g. `export BLACE_AI_CMAKE_DIR="<unzip_folder>/package/cmake"`. 
...
### Artifacts
| [**Torchscript Payload**](https://blace-ai-public.b-cdn.net/model-payload/c028e31c6b64c85b287f60aa404dbc11.bin) | <td border-style="hidden" border="0"><b style="font-size:30px"><a href="https://blace-ai-public.b-cdn.net/model-payload/f3e6d34310f7b9beca74a16ff474f4c8.bin">ONNX FP32 Payload</a></b></td><td border-style="hidden" border="0"><b style="font-size:30px"><a href="https://blace-ai-public.b-cdn.net/model-payload/cd14b16a61d0b35592a8338f89595105.bin">ONNX FP16 Payload</a></b></td> | [**Demo Project**](https://blace-ai-public.b-cdn.net/demos/depth_anything_v3_v6_mono_large_v1_ALL_export_version_v26_demo.zip) | [**Header**](https://blace-ai-public.b-cdn.net/model-defs/depth_anything_v3_v6_mono_large_v1_ALL_export_version_v26.h) |
|--------------------------------------------------------|---------------------|------------------------------------|------------------------------|
          

### [License](https://github.com/ByteDance-Seed/Depth-Anything-3/blob/main/LICENSE)
