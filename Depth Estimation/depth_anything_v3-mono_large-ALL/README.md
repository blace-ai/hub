...
#include "depth_anything_v3_v2_mono_large_v1_ALL_export_version_v26.h"
...
int main() {
  ...
  auto infer_op = depth_anything_v3_v2_mono_large_v1_ALL_export_version_v26_run(
...
```
Tested on version [v1.1.1](https://github.com/blace-ai/blace-ai/releases/tag/v1.1.1) of blace.ai sdk. Might also work on newer or older releases (check if release notes of blace.ai state breaking changes).

### Quickstart
1. Download [blace.ai SDK](https://github.com/blace-ai/blace-ai/releases/tag/v1.1.1) and unzip. In the bootstrap script `build_run_demos.ps1` (Windows) or `build_run_demos.sh` (Linux/MacOS) set the `BLACE_AI_CMAKE_DIR` environment variable to the `cmake` folder inside the unzipped SDK, e.g. `export BLACE_AI_CMAKE_DIR="<unzip_folder>/package/cmake"`. 
...
### Artifacts
| [**Torchscript Payload**](https://blace-ai-public.b-cdn.net/model-payload/1cc19328467aa4f48f4f39a1f8035f92.bin) |  | [**Demo Project**](https://blace-ai-public.b-cdn.net/demos/depth_anything_v3_v2_mono_large_v1_ALL_export_version_v26_demo.zip) | [**Header**](https://blace-ai-public.b-cdn.net/model-defs/depth_anything_v3_v2_mono_large_v1_ALL_export_version_v26.h) |
|--------------------------------------------------------|---------------------|------------------------------------|------------------------------|
