...
#include "depth_anything_v3_v2_mono_large_v1_ALL_export_version_v25.h"
...
int main() {
  ...
  auto infer_op = depth_anything_v3_v2_mono_large_v1_ALL_export_version_v25_run(
...
```
Tested on version [v0.9.96](https://github.com/blace-ai/blace-ai/releases/tag/v0.9.96) of blace.ai sdk. Might also work on newer or older releases (check if release notes of blace.ai state breaking changes).

### Quickstart
1. Download [blace.ai SDK](https://github.com/blace-ai/blace-ai/releases/tag/v0.9.96) and unzip. In the bootstrap script `build_run_demos.ps1` (Windows) or `build_run_demos.sh` (Linux/MacOS) set the `BLACE_AI_CMAKE_DIR` environment variable to the `cmake` folder inside the unzipped SDK, e.g. `export BLACE_AI_CMAKE_DIR="<unzip_folder>/package/cmake"`. 
...
### Artifacts
| [**Torchscript Payload**](https://blace-ai-public.b-cdn.net/model-payload/edee19778fa4e5fabd779e488b7419cc.bin) |  | [**Demo Project**](https://blace-ai-public.b-cdn.net/demos/depth_anything_v3_v2_mono_large_v1_ALL_export_version_v25_demo.zip) | [**Header**](https://blace-ai-public.b-cdn.net/model-defs/depth_anything_v3_v2_mono_large_v1_ALL_export_version_v25.h) |
|--------------------------------------------------------|---------------------|------------------------------------|------------------------------|
