<h2 style="text-align:center;">Distillanydepth (large)</h2>
...
#include "DistillAnyDepth_v1_large_v1_ALL_export_version_v26.h"
...
int main() {
  ...
  auto infer_op = DistillAnyDepth_v1_large_v1_ALL_export_version_v26_run(
...
### Artifacts
| [**Torchscript Payload**](https://blace-ai-public.b-cdn.net/model-payload/af915d346c5242564e58c0c6a3506d77.bin) |  | [**Demo Project**](https://blace-ai-public.b-cdn.net/demos/DistillAnyDepth_v1_large_v1_ALL_export_version_v26_demo.zip) | [**Header**](https://blace-ai-public.b-cdn.net/model-defs/DistillAnyDepth_v1_large_v1_ALL_export_version_v26.h) |
|--------------------------------------------------------|---------------------|------------------------------------|------------------------------|
